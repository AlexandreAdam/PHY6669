...
des paramètres de densités d'aujourd'hui (on omet les indices 0):
\[
        \boxed{R = \frac{3}{4} \frac{\Omega_b}{\Omega_r}a}
\]
...
obtenir
\[
        \Gamma_T = \frac{3H_0^2}{8 \pi G m_p} X_e \Omega_b a^{-3} 
...
\]
Au moment de la recombinaison, $X_e \simeq 10^{-2}$, donc
\[
        \frac{\Gamma_T}{H} = 1 = 
                6.9108\times 10^{-4} 
                \frac{\Omega_b h a^{-3}}{
                        \sqrt{\Omega_r a^{-4} + \Omega_m a^{-3}}
                }
\]
