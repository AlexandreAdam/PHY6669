...
\begin{figure}[H]
        ...
        \end{subfigure}
\end{figure}
La densité numérique des photons se calcule directement à partir de la distribution 
de Planck
\begin{equation}\label{eq:PlanckDensity} 
        ...
        \frac{\nu^2 d\nu}{\exp \left\{ h\nu / k_B T \right\} - 1}
\end{equation} 
Avec substitution on retrouve une forme standard pour l'intégrale qui devient
\[
...
\[
        \eta_b = 6 \times 10^{-10}
\]
au moment de la nucléosynthèse (après annihilation des antiparticules), on peut 
tenter de déterminer le moment (la température) à partir duquel les électrons 
ne seront plus en équilibre avec le processus de création/annihilation de paires. En 
...
obtenu correspond 
au redshift $z_{\text{dec}} \simeq 1121$. Notons que la fraction d'ionisation 
...
dans le facteur de Hubble. Ainsi, avec l'approximation de Saha on obtient
\[
...
\]
où l'entropie est gardée constante. Comme la pression du fluide 
baryons photons est dominée par la pression des photons:
\[
...
\[
        ...
        = \frac{2}{\Omega_m H_0} (\sqrt{\Omega_r + \Omega_m a} - \sqrt{\Omega_r})
\]
...
%À ce moment, l'Univers est dominé par 
...
\[
        P(\sigma \mid \mathcal{D}, \mu) = \frac{1}{\displaystyle \int_0^{\infty }P(\sigma)d\sigma}
        \left(\frac{1}{\sqrt{2\pi}\sigma}  \right)^{|\mathcal{D}|} 
        \exp
        \left\{ -\frac{1}{2\sigma^2}\sum_{i=1}^{|\mathcal{D}|}
        (d_i - \mu)^{2}\right\}, \hspace{1cm} \sigma > 0
\]
Avec un changement de variable, on peut déterminer la 
constante de normalisation
\[
        \int_0^{\infty }P(\sigma)d\sigma = 
        \left(\frac{1}{\sqrt{2\pi}}  \right)^{|\mathcal{D}|}   
        \int_0^{\infty} \left( \frac{1}{\sigma} \right)^{|\mathcal{D}|}
        \exp \bigg\{ -\frac{1}{\sigma^2}\overbrace{\frac{1}{2}\sum_{i=1}^{|\mathcal{D}|}(d_i - \mu)^{2}}^{\equiv \alpha^2} \bigg\}
        d\sigma
\]
On pose $x \equiv \alpha^2\sigma^{-2} \implies dx = -2\alpha^2 \sigma^{-3}d\sigma \implies d\sigma = -\dfrac{dx}{2\alpha^2 x^{3/2}}$:
\begin{align*}
        \int_0^{\infty }P(\sigma)d\sigma &= 
        \frac{1}{2\alpha^{|\mathcal{D}| - 1}}\left(\frac{1}{ \sqrt{2\pi}}  \right)^{|\mathcal{D}|}   
        \int_0^{\infty} x^{|\mathcal{D}|/2}
        \exp \left\{ - x \right\}
        \frac{dx}{x^{3/2}} \\
        &=
        \frac{1}{2\alpha^{|\mathcal{D}| - 1}}\left(\frac{1}{\sqrt{2\pi}}  \right)^{|\mathcal{D}|}   
        \Gamma \left(\frac{|\mathcal{D}| - 1}{2}\right)
\end{align*}
D'où la distribution \textit{a posteriori}
\[
        \boxed{P(\sigma \mid \mathcal{D}, \mu) = \frac{2\alpha^{|\mathcal{D}| - 1}}{\Gamma \left( \dfrac{\mathcal{D} - 1}{2} \right)}
        \left( \frac{1}{\sigma} \right)^{|\mathcal{D}|}
\exp \left\{ - \left( \frac{\alpha}{\sigma} \right)^{2} \right\}}
\]
D'un autre côté, pour $\pi(\sigma^2) = 1$, on a (en posant $\alpha^2 \rightarrow \alpha$) 
\[
        \int_0^{\infty }P(\sigma^2)d\sigma^2 = 
        \left(\frac{1}{\sqrt{2\pi}}  \right)^{|\mathcal{D}|}   
        \int_0^{\infty} \left( \frac{1}{\sigma^2} \right)^{|\mathcal{D}|/2}
        \exp \bigg\{ -\frac{\alpha}{\sigma^2} \bigg\}
        d\sigma^2
\]
En posant $x \equiv \alpha/\sigma^2 \implies dx = -\alpha d\sigma^2/\sigma^4 \implies d\sigma^2 = -\alpha dx / x^2$:
\begin{align*}
        \int_0^{\infty }P(\sigma^2)d\sigma^2 &= 
        \frac{1}{\alpha^{|\mathcal{D}|/2}}\left(\frac{1}{\sqrt{2\pi}}  \right)^{|\mathcal{D}|}   
        \int_0^{\infty}  x^{|\mathcal{D}|/2}
        \exp \left\{ -x \right\}
        \frac{\alpha dx}{x^2}\\
        &=
        \frac{1}{\alpha^{|\mathcal{D}|/2 - 1}}\left(\frac{1}{\sqrt{2\pi}}  \right)^{|\mathcal{D}|}   
        \Gamma \left( \frac{|\mathcal{D}|}{2} - 1 \right)
\end{align*}
Donc
\[
        \boxed{P(\sigma^2 \mid \mathcal{D}, \mu) = 
        \frac{\alpha^{|\mathcal{D}|/2 - 1}}{\Gamma \left( \dfrac{|\mathcal{D}|}{2} - 1 \right)}
        \left( \frac{1}{\sigma^2} \right)^{|\mathcal{D}|/2}
        \exp \left\{ - \frac{\alpha}{\sigma^2} \right\}
}
\]
